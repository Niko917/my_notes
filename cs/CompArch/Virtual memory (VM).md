...
![[Virtual adress translation 1.png|600]]
...
![[adress translation 1.png]]

---
## Translation lookaside buffer

**Translation Lookaside Buffer (TLB)** — это кэш, используемый в современных компьютерных системах для ускорения трансляции адресов. TLB располагается в CPU.
...
В случае использования TLB, VPN внутри виртуального адреса делится на 2 части:

- **TLBI (TLB Index)**
	- это индекс для определения необходимого поля внутри TLB.
		- Если TLB имеет $\large T = 2^t$ полей, то TLBI состоит из $\large t$ бит
	
- **TLBT (TLB Tag)**
	- это оставшиеся биты VPN.

![[VPN layout 1.png|500]]
...
![[TLB adress translation 1.png|500]]
...
![[page tables hierarchy 1 1.png]]

на примере Intel Core i7 рассмотрим содержимое PTEs на разных уровнях в иерархии. Intel Core i7 поддерживает 4-х уровневую табличную иерархию.

![[Intel core i7 vm 1 1.png|700]]
