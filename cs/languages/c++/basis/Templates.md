[Шаблоны](https://ru.cppreference.com/w/cpp/language/templates) - это механизм, позволяющий параметризовать тип  и использовать одни и те же функции или классы для обработки данных разных типов.
